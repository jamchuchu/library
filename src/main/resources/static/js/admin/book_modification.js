...
:8000/api/admin/book/${bookObj.bookCode}`,
            dataType: "json",
            success: response => {
...
:8000/api/admin/book/${bookObj.bookCode}/image/${imgObj.imageId}`,
            dataType: "json",
            success: response => {
                successFlag = true;
            },
...
:8000/api/admin/book/${bookObj.bookCode}/images`,
...
class BookModificationService {
    ...
    loadBookAndImageData() {
        ...
        if(responseData.bookImage != null){
            ...
            bookImg.src = `http://localhost

:8000/image/book/${responseData.bookImage.saveName}`;
        }
    }
